function [xx_s,xx_f,yy_s,yy_f,zz_s,zz_f,xx_us,xx_uf,yy_us,yy_uf,zz_us,zz_uf] = ...
    construct_grid(grid_size,mot_uf,d1,d2,d3,min_patch_size)
% get grid for registration
% mot_uf: degree of patch upsampling

% last update: 6/16/2020. YZ
...
% what is this?, why add d1? looks like a differential?
...
grid_size_us = floor(grid_size./mot_uf); % reduce the grid size
...
if mot_uf(1) > 1
    ...
    xx_us = xx_s; xx_uf = xx_f; % u stands for upsampling
end
if mot_uf(2) > 1
