...
xx = [linspace(1/(regular_grid(1)-extended_grid(1)+1),1,regular_grid(1)-extended_grid(1)), ...
    ones(1,regular_grid(2)-regular_grid(1)+1), ...
    fliplr(linspace(1/(extended_grid(2)-regular_grid(2)+1),1,extended_grid(2)-regular_grid(2)))];
